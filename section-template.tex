...
``footfullcite,'' meaning this is the first time the cite has appeared;\footfullcite[][p. 303]{Ellison-1985} and a third is a ``footcite'' (meaning, it will reflect that the footfullcite has been cited earlier.)\footcite[][p. 304]{Ellison-1985}. The rest of this is dummy text using the ipsum package, except that here si an excerpt of a source with appropriate indentation. The first footfullcite was to an article; this one is to a book.\footfullcite[][p. 349]{Banton-1983} And here is a footcite to the same source:\footcite[][p. 392]{Banton-1983}
